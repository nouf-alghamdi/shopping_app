                      ...
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            ...
                            const Text('+966-568498802', style: TextStyle(fontSize: 16, fontWeight: FontWeight.normal)),
                            const Text('Saudi Arabia - Riyadh',
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        Row(
                          mainAxisAlignment: MainAxisAlignment.spaceBetween,
                          children: const [Text('Sub Total'), Text('1150.00 SAR')],
                        ),
                        Row(
                          mainAxisAlignment: MainAxisAlignment.spaceBetween,
                          children: const [
